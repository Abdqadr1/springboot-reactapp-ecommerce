                                ...
                                ? 
                                    <NavDropdown title="Products" id="basic-nav-dropdown" menuVariant="dark">
                                        ...
                                        }
                                        {
                                            ...
                                            ? <>
                                                <Link data-rr-ui-dropdown-item="" className="dropdown-item" to="/account/reviews">Reviews</Link>
                                                <Link data-rr-ui-dropdown-item="" className="dropdown-item" to="/account/questions">Questions</Link>
                                            </>
                                            : ""
                                        }
                                        {
                            ...
                            (hasAnyAuthority(auth, ["Admin", "Salesperson", "Shipper", "Editor"]))
                                ? 
                                    <NavDropdown title="Menu" id="basic-nav-dropdown" menuVariant="dark">
                                        ...
                                        {
                                            (hasAnyAuthority(auth, ["Admin", "Editor"]))
                                                ? <Link data-rr-ui-dropdown-item="" className="dropdown-item" to="/account/menus">Menus</Link>
                                                : ""
                                        }
                                        {
                                            (hasAnyAuthority(auth, ["Admin", "Editor"]))
                                                ? <Link data-rr-ui-dropdown-item="" className="dropdown-item" to="/account/storefronts">Home page</Link>
                                                : ""
                                        }
                                    </NavDropdown>
                                : ""
