                    ...
                    <Col xs={11} className="p-2 border rounded">
                        <Row className="justify-content-center justify-content-md-center">
                            ...
                            <Col xs={11} md={6}>
                                ...
                                {
                                    (!detail.product.reviewedByCustomer && detail.product.customerCanReview) &&
                                    <Button onClick={()=>setShowReviewForm(s=>({...s,show:true, product: detail.product}))} variant="info" className="mt-1">Write Review</Button>
                                }
                                {
